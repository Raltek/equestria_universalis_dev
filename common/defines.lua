...
NFrontend = {
	CAMERA_LOOKAT_X = 2690.0, 						-- Rotation point in main menu
	CAMERA_LOOKAT_Y = 0.0,
	CAMERA_LOOKAT_Z = 1519.0,
	CAMERA_LOOKAT_SETTINGS_X = 2690.0, 				-- Rotation point in settings
	CAMERA_LOOKAT_SETTINGS_Y = 0.0,					-- Y is height
	CAMERA_LOOKAT_SETTINGS_Z = 1519.0,
	CAMERA_START_X = 2690.0,						-- Initial position in main menu
	CAMERA_START_Y = 800,							-- Y is height
	CAMERA_START_Z = 1400.0,
	CAMERA_END_X = 2690.0,							-- Move to position in main menu
	CAMERA_END_Y = 900.0,
	CAMERA_END_Z = 1400.0,
	...
	FRONTEND_POS_X = 2690.0,
	FRONTEND_POS_Y = 1500.0,
	FRONTEND_POS_Z = 1500.0,
	FRONTEND_LOOK_X = 2690.0,
	FRONTEND_LOOK_Y = 0.0,
	FRONTEND_LOOK_Z = 1519.0,

	SETTINGS_POS_X = 2690.0,
	SETTINGS_POS_Y = 951.0,
	SETTINGS_POS_Z = 978.0,
	SETTINGS_LOOK_X = 2758.0,
	SETTINGS_LOOK_Y = 0.0,
	SETTINGS_LOOK_Z = 1246.0,

	MP_OPTIONS_POS_X = 2690.0,
	MP_OPTIONS_POS_Y = 922.0,
	MP_OPTIONS_POS_Z = 1048.0,
	MP_OPTIONS_LOOK_X = 2690.0,
	...
	CONTENT_POS_X = 2690.0,
	CONTENT_POS_Y = 922.0,
	CONTENT_POS_Z = 1308.0,
	CONTENT_LOOK_X = 2690.0,
	CONTENT_LOOK_Y = 0.0,
